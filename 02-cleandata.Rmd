...
young <- young_raw |> 
  ...
  # Defining outcome
  mutate(mi = as.integer(if_any(c(mi_ever_99, mi_ever_01, mi_ever_03, heartprob_95, heartprob_97, heartprob_99, heartprob_01, heartprob_03), ~ . == 1 & !is.na(.)))) |> 
...
young2 <- young_raw |> 
  ...
  # Defining outcome
  mutate(mi = as.integer(if_any(c(mi_ever_99, mi_ever_01, mi_ever_03), ~ . == 1 & !is.na(.)))) |> 
...
```{r}
full_db2 <- rbind(young2, mature2)

# write_rds(full_db2, "data/joined-db2-clean.rds")
```
